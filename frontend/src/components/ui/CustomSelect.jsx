  ...
  return (
    <div ref={ref} className="relative w-full">
      <button
        ...
        className="w-full flex justify-between items-center text-sm px-4 py-2 bg-zinc-100 dark:bg-zinc-800 text-zinc-950 dark:text-white border border-zinc-200 dark:border-zinc-700 rounded-lg focus:outline-none cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors"
      >
      ...
      {open && (
        <div className="absolute top-[calc(100%+6px)] left-0 w-full bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg shadow-lg z-[999] p-1 flex flex-col gap-0.5">
          {options.map((option) => {
